...
U.S. Marine Corps veteran transitioning into Information Technology and Cybersecurity with experience in avionics systems, industrial technology, and technical operations. Supported mission-critical environments through avionics maintenance, technical troubleshooting, quality assurance, data management, and structured maintenance processes.

Military experience includes avionics maintenance systems such as NALCOMIS and Microsoft Access, hazardous materials operations, and service as a Collateral Duty Inspector/Quality Assurance responsible for verifying maintenance actions, system testing, troubleshooting, and repairs met technical publications and safety standards. Previously held a Secret security clearance while working in environments requiring accountability, attention to detail, and strict adherence to procedures.

Industrial maintenance experience includes high-voltage electrical systems, schematics, root cause analysis, SAP maintenance systems, PLCs, and robotics. Currently developing IT skills as an ITSA student at My Computer Career, focusing on networking, operating systems, server administration, and cybersecurity fundamentals.
...
![HTML](https://img.shields.io/badge/HTML-0078D4?style=flat-square)
![PowerShell](https://img.shields.io/badge/PowerShell-0078D4?style=flat-square)
![SQL](https://img.shields.io/badge/SQL-0078D4?style=flat-square)
![PLC Ladder Logic](https://img.shields.io/badge/PLC%20Ladder%20Logic-0078D4?style=flat-square)
...
![Security Best Practices](https://img.shields.io/badge/Security%20Best%20Practices-0078D4?style=flat-square)
...
![Fault Isolation](https://img.shields.io/badge/Fault%20Isolation-0078D4?style=flat-square)
![Quality Assurance](https://img.shields.io/badge/Quality%20Assurance-0078D4?style=flat-square)

#### ⚡ Industrial Technology

![Electrical Systems](https://img.shields.io/badge/Electrical%20Systems-0078D4?style=flat-square)
![PLC Programming Fundamentals](https://img.shields.io/badge/PLC%20Programming%20Fundamentals-0078D4?style=flat-square)
...
![Microsoft Access](https://img.shields.io/badge/Microsoft%20Access-0078D4?style=flat-square)
